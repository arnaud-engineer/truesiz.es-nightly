	...
	========================================================================= */
		...
		// SmartPhones
			...
			// HUAWEI
				...
				// Y Series
			new Device("Huawei Y9s", "STK-L21", "", 6.59, 391, 1080, 2340),
			new Device("Huawei Y9s", "STK-LX3", "", 6.59, 391, 1080, 2340),
			new Device("Huawei Y9s", "STK-L22", "", 6.59, 391, 1080, 2340),
			new Device("Huawei Y9a", "FRL-22", "", 6.63, 397, 1080, 2400),
			new Device("Huawei Y9a", "FRL-23", "", 6.63, 397, 1080, 2400),
			new Device("Huawei Y9a", "FRL-L22", "", 6.63, 397, 1080, 2400),

			new Device("Huawei Y8p", "AQM-LX1", "", 6.3, 418, 1080, 2400),
			new Device("Huawei Y8s", "JKM-LX", "", 6.5, 396, 1080, 2340), //1-3

			new Device("Huawei Y7p", "ART-L28", "", 6.39, 269, 720, 1560),
			new Device("Huawei Y7p", "ART-L29", "", 6.39, 269, 720, 1560),
			new Device("Huawei Y7a", "PPA-LX", "", 6.67, 395, 1080, 2400), // 1-3
			...
			new Device("Huawei P Smart 2021", "PPA-LX2", "", 6.67, 395, 1080, 2400),
			new Device("Huawei P Smart 2020", "POT-LX1A", "", 6.21, 415, 1080, 2340),

			new Device("Huawei P Smart Pro", "STK-L21", "", 6.59, 391, 1080, 2340), // 2019
			// FIG-LX1 - 2019 (sur : POT-LX1)
			//new Device("Huawei P Smart S", "AQM-LX1", "", 6.3, 418, 1080, 2400),
			...
			new Device("Huawei P40 Lite E", "ART-L28", "", 6.39, 269, 720, 1560),
			new Device("Huawei P40 Lite E", "ART-L29", "", 6.39, 269, 720, 1560),
			//new Device("Huawei P40 Lite E", "ART-L29N", "", 6.39, 269, 720, 1560),
			new Device("Huawei P40 Lite", "CDY-NX9A", "", 6.5, 405, 1080, 2400),
			new Device("Huawei P40 Lite", "JNY-L21A", "", 6.5, 405, 1080, 2400),
			new Device("Huawei P40 Lite", "JNY-L01A", "", 6.5, 405, 1080, 2400),
			new Device("Huawei P40 Lite", "JNY-L21B", "", 6.5, 405, 1080, 2400),
			new Device("Huawei P40 Lite", "JNY-L22A", "", 6.5, 405, 1080, 2400),
			new Device("Huawei P40 Lite", "JNY-L02A", "", 6.5, 405, 1080, 2400),
			new Device("Huawei P40 Lite", "JNY-L22B", "", 6.5, 405, 1080, 2400),
			...
			//new Device("Huawei P30", "ELE-L29", "", 5.0, 441, 1080, 1920),
			//new Device("Huawei P20 Pro", "CLT-L29", "", 5.0, 441, 1080, 1920),
			//new Device("Huawei P20", "EML-L29", "", 5.0, 441, 1080, 1920),
			...
			new Device("Huawei Mate 30 Pro New Edition", "VOG-L29", "", 6.47, 398, 1080, 2340),
			...
			//new Device("Huawei Mate 20 X", "EVR-L29", "", 5.0, 441, 1080, 1920),
			//new Device("Huawei Mate 10 Pro", "BLA-L29", "", 5.0, 441, 1080, 1920),
			...
			new Device("Huawei Nova 7i", "JNY-L22B", "", 6.4, 398, 1080, 2310),
			new Device("Huawei Nova 7i", "JNY-L21A", "", 6.4, 398, 1080, 2310),
			new Device("Huawei Nova 7i", "JNY-L01A", "", 6.4, 398, 1080, 2310),
			new Device("Huawei Nova 7i", "JNY-L21B", "", 6.4, 398, 1080, 2310),
			new Device("Huawei Nova 7i", "JNY-L22A", "", 6.4, 398, 1080, 2310),
			new Device("Huawei Nova 7i", "JNY-L02A", "", 6.4, 398, 1080, 2310),
