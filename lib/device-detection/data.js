...
/*  =========================================================================
	...
	/*
		...
		- Is not relevant anymore when not using the built-in screen
	*/
		...
		var lIphone = [
			...
			//new Device("iPhone 4", "", "A4", 3.5, 326, 640, 960),
			new Device("iPhone 4", "", "PowerVR SGX 535", 3.5, 326, 640, 960),
			//new Device("iPhone 4S", "", "A5", 3.5, 326, 640, 960),
			...
			new Device("iPhone 5 / 5S / 5C", "", "A10", 4, 326, 640, 1136, 2),
		...
		var lIpad = [
			//new Device("iPad Mini", "", 7.9, 163, 768, 1024), //confusion
			//a5

			// Non-retina (devicePixelRatio == 1)
			new Device("iPad 1", "", "PowerVR SGX 535", 9.7, 132, 768, 1024), //confusion
			new Device("iPad 2 / iPad Mini 1", "", "PowerVR SGX 543", 9.7, 132, 768, 1024, 2), //confusion
			new Device("iPad 1-2 / iPad Mini 1", "", "", 9.7, 132, 768, 1024), //confusion
			// 7.9 / 9.7
			new Device("iPad 3", "", "PowerVR SGX 543", 9.7, 264, 1536, 2048),
			new Device("iPad 4", "", "PowerVR SGX 554", 9.7, 264, 1536, 2048), // confusion
			new Device("iPad Mini 2-3 / iPad Air 1", "", "A7", 7.9, 326, 1536, 2048, 1), // confusion avec iPad Air 1
			...
			new Device("iPad Mini 5", "", "A12", 7.9, 326, 1536, 2048), // unsure TODO : check à la fnac wesh
			new Device("iPad 3-6 / iPad Air 1-2 / iPad Pro 9.7", "", "", 9.7, 264, 1536, 2048, 1), //confusion
			// Modern iPad
			...
			new Device("iPad Pro 11 (2021)", "", "M1", 11.0, 264, 1668, 2388), // guess
			...
			new Device("iPad Pro 12.9 (2021)", "", "M1", 12.9, 264, 2048, 2732), // guess
			new Device("iPad Pro 12.9", "", "", 12.9, 264, 2048, 2732),
			// DEFAULT
			new Device("Unknown iPad", "", "", 10, 264, 1536, 2048, 1) // TODO : UNKNOW iPAD = EXTERNAL MONITOR ?



			// iPad screen ratio calculation to estimate if external monitor
		];
		...
		var lMac = [
			...
			//new Device("iMac 21", "", "", 21.5, 102, 1080, 1921, 2),
			...
			new Device("MacBook 13 Retina", "", "5100", 13.3, 220, 1800, 2880, 3), // unsure it will works, but iris 5100 only on 13 inches models
			new Device("MacBook 13 Retina", "", "6100", 13.3, 220, 1800, 2880, 3),
			new Device("MacBook 13 Retina", "", "540", 13.3, 220, 1800, 2880, 3), //iris
			new Device("MacBook 13 Retina", "", "550", 13.3, 220, 1800, 2880, 3), //iris
			new Device("MacBook 13 Retina", "", "640", 13.3, 220, 1800, 2880, 3), //iris
			new Device("MacBook 13 Retina", "", "645", 13.3, 220, 1800, 2880, 3), //iris
			new Device("MacBook 13 Retina", "", "650", 13.3, 220, 1800, 2880, 3), //iris
			new Device("MacBook 13 Retina", "", "655", 13.3, 220, 1800, 2880, 3), //iris
			new Device("MacBook 13 Retina", "", "M1", 13.3, 220, 1800, 2880, 3), // absolute experimental
			//new Device("MacBook 13 Retina", "", "Intel(R) Iris(TM) Plus Graphics 655", 13.3, 220, 1800, 2880, 2),
			new Device("MacBook Pro 15 Retina", "", "4000", 15.4, 220, 1800, 2880, 3), // might be on 13 too, but resolution is supposed to be different
			new Device("MacBook Pro 15 Retina", "", "5200", 15.4, 220, 1800, 2880, 3),
			new Device("MacBook Pro 15 Retina", "", "530", 15.4, 220, 1800, 2880, 3), // iris
			new Device("MacBook Pro 15 Retina", "", "630", 15.4, 220, 1800, 2880, 3), // iris
			new Device("MacBook Pro 15 Retina", "", "", 15.4, 220, 1800, 2880, 2),
			new Device("MacBook Pro 15 Retina", "", "", 15.4, 220, 2100, 3360, 2), // if scale change
	...
	/*  ----------------------------------------
		...
		*/
		...
		var lChromebook = [
			...
			new Device("Pixelbook-like", "", "", 12.3, 235, 1600, 2400, 1),
			new Device("Pixel Chromebook", "", "", 12.85, 239, 1700, 2560, 1),
			new Device("Chromebook 13 (G1)", "", "", 13.3, 276, 1800, 3200, 1),
			new Device("Pixel Slate-like", "", "", 12.3, 293, 2000, 3000, 1),
			new Device("Pixelbook Go-like", "", "", 13.3, 331, 2160, 3840, 1),
			// basic chromebook is 11.6
			new Device("Unknown Chromebook", "", "", 21.5, 103, 1080, 1920, 0, false) // we consider we are on an extern monitor
		];
	...
	/*  ----------------------------------------
		...
		var lTablet = [
			...
			new Device("Entry-level tablet", "", "", 8.0, 160, 768, 1024, 1), // TODO
			...
			new Device("Unknown Tablet", "", "", 7.0, 216, 800, 1280, 0) // we consider we are on a cheap 7.0" tablet
		];
	...
	/*  ----------------------------------------
		...
		var lMobile = [
			...
			new Device("Unknown Phone", "", "", 6.0, 216, 1080, 1920, 0) // we consider we are on a 6.0 inches HD phone
		];
	...
	/*  ----------------------------------------
		...
		var lLaptop = [
			...
			new Device("4:3 Laptop", "", "", 15.6, 276, 1200, 1600, 1), //4:3 1080i
			new Device("4:3 Laptop", "", "", 15.6, 276, 1280, 1600, 1), //4:3 1080i
			new Device("4:3 Laptop", "", "", 15.6, 276, 1344, 1792, 1), //4:3 1080i
			new Device("4:3 Laptop", "", "", 15.6, 276, 1392, 1856, 1), //4:3 1080i
			new Device("4:3 Laptop", "", "", 15.6, 276, 1440, 1800, 1), //4:3 1080i
			new Device("4:3 Laptop", "", "", 15.6, 276, 1440, 1920, 1), //4:3 1080i
			new Device("4:3 Laptop", "", "", 15.6, 276, 1920, 2560, 1), //4:3 1080i
			// HD
...
/*  =========================================================================
	...
	========================================================================= */
		...
		var lUserAgentDetectable = [
			...
			//new Device("Acer Chromebook 15", "", "", 15.6, 141, 1080, 1920),
			...
			//new Device("Chromebook Tab 10", "", "", 9.7, 264, 1536, 2048),
			//new Device("Chromebook Spin 13 / 713", "", "", 13.3, 191, 1504, 2048),
			...
			// https://www.lesnumeriques.com/tablette-tactile/comparatif-choisir-sa-tablette-tactile-connectee-a1048.html
			//new Device("Flytouch 7", "BC1003 Build", "", 10.1, 118, 600, 1024),
			// Fujitsu tab
			...
			new Device("Xiaomi Mi Pad 4", "MI PAD 4 PLUS", "", 10.1, 224, 1200, 1920),
			// SAMSUNG TABLETS
				// Old Galaxy Tab
			...
			new Device("Samsung Galaxy Tab S6", "SM-T86", "", 10.5, 288, 1600, 2560), // verif
			...
			// https://developers.whatismybrowser.com/useragents/parse/44242117nook-web-browser-android-nook-ereader-webkit
			...
			// https://developers.whatismybrowser.com/useragents/explore/operating_platform_string/?utm_source=whatismybrowsercom&utm_medium=internal&utm_campaign=breadcrumbs

			// Samsung https://developers.whatismybrowser.com/useragents/explore/operating_platform_string/samsung-galaxy-tab-4-nook-10-1-sm-t530nu/4
			// Chuwi, Mi Pad, ...
			// ODD TABLETS
			new Device("BlackBerry PlayBook", "PlayBook", "", 7.0, 170, 600, 1024),
			new Device("HP TouchPad", "hpwOS", "", 8.9, 144, 768, 1024),
			// LAPTOP
			// Laptop HP6560b 15.6 pouces multi res
			...
			new Device("Samsung Galaxy A5 (2015)", "SM-A500FU", "", 5.0, 294, 720, 1280),
			new Device("Samsung Galaxy A5 (2017)", "SM-A520F", "", 5.0, 294, 720, 1280),
			new Device("Samsung Galaxy A50", "SM-A505F", "", 6.4, 403, 1080, 2340),
			new Device("Samsung Galaxy A80", "SM-A805F", "", 6.7, 393, 1080, 2400),


			new Device("Samsung Galaxy Note 10+", "SM-N976V", "", 6.8, 498, 1440, 3040),


			// https://fr.wikipedia.org/wiki/Samsung_Galaxy#Galaxy_S
			...
			// revoir gamme complete Archos
			// Marques à voir : Digma (russe), Genesis Tab, Hip Street Tablet
			// Alcatel detection seem shitty https://github.com/matomo-org/device-detector/issues/5808 https://www.alcatelmobile.com/support/product-support/
			// tablet detection android https://qastack.fr/programming/5341637/how-do-detect-android-tablets-in-general-useragent
			/* LAPTOP OR DESTOP DETECTION THROUGH BATTERY : https://stackoverflow.com/questions/42596664/detect-whether-client-system-is-laptop-or-desktop-using-javascript */
			// http://www.webapps-online.com/online-tools/user-agent-strings/dv/brand55230/hp-laptop
